    ...
    <div className="w-full min-h-screen bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center gap-10 flex-col py-10">
      ...
      <div className="inline-flex items-center gap-2">
        <label
          ...
          className="text-zinc-200 text-md cursor-pointer"
        >
          Male
        </label>
        ...
        <div className="relative inline-block w-11 h-5">
          ...
          <label
            htmlFor="switch-component-on"
            className="absolute top-0 left-0 w-5 h-5 bg-white rounded-full border border-zinc-600 shadow-sm transition-transform duration-300 peer-checked:translate-x-6 peer-checked:border-zinc-600 cursor-pointer"
          ></label>
        </div>
      ...
      <div className="flex justify-center items-center gap-5 flex-wrap overflow-hidden px-[10vw]">
        ...
        <div className="w-[20vw] h-[25vw] bg-red-200 rounded-xl overflow-hidden relative">
          <Lable />
        </div>
        <div className="w-[20vw] h-[25vw] bg-red-200 rounded-xl overflow-hidden relative">
          <Lable />
